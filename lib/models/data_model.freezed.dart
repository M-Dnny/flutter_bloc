...
DataModel _$DataModelFromJson(Map<String, dynamic> json) {
  return _$_DataModel.fromJson(json);
}
...
/// @nodoc
@JsonSerializable()
class _$_$_DataModel implements _$_DataModel {
  _$_$_DataModel(
      {required this.id,
      required this.title,
      required this.worth,
  ...
  factory _$_$_DataModel.fromJson(Map<String, dynamic> json) =>
...
abstract class _$_DataModel implements DataModel {
  factory _$_DataModel(
      {required int id,
      required String title,
      required String worth,
      required String thumbnail,
      ...
      required int users,
      required String status,
      required String gamerpower_url}) = _$_$_DataModel;

  factory _$_DataModel.fromJson(Map<String, dynamic> json) =
      _$_$_DataModel.fromJson;
